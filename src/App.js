          ...
          series: {
            ...
            point: {
              events: {
                ...
                drop: (data) => {
                  this.imagePloatingAfterDrag(data);
                  line.destroy();
                  line = "";
                },
              },
          ...
          events: {
            ...
            afterExpand: (event) => {
              setTimeout(() => {
                ...
                let chartt = this.chartComponent.current.chart;
    ...
    document
      ...
      .addEventListener("mousewheel", (event) => {
        if (event.ctrlKey == true) {
          ...
          if (event.deltaY == -100)
            this.chartComponent.current.chart.mapZoom(0.9);
          else this.chartComponent.current.chart.mapZoom(1.1);
          this.zoomCallback();
        }
      });
  }
